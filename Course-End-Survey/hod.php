...
<marquee scrollamount="20"   style="font-family:courier;font-size:40px;color:yellow;">HELLO SIR/MADAM!!!WELCOME TO COURSE END SURVEY.</marquee><br><br><br><br><center>
<form action="hod.php" onsubmit="return(validate());" method="POST">
<label style="color:white;"><b>USERNAME:</b><input type="text" name="usn" ></label><br><br>
...
<form action="rproj1.html"><input type="submit" value="HOME"></form>
</body></center>
</html>
