...
<div class="three"><p style="font-family:'monotype corsiva';font-size:40px;color:black;">Q2.Does the teacher indicates important points to remember?</p>
<form action="q1.php" method="POST">
<label><input type="radio" name="q1" value="5"/>5</label><br><br>
<label><input type="radio" name="q1" value="4"/>4</label><br><br>
<label><input type="radio" name="q1" value="3"/>3</label><br><br>
<label><input type="radio" name="q1" value="2"/>2</label><br><br>
<label><input type="radio" name="q1" value="1"/>1</label><br><br>
<br><br><br><br>
