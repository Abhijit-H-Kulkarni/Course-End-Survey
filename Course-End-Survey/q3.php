...
<div class="three"><p style="font-family:'monotype corsiva';font-size:40px;color:black;">Q4.Does the teacher provide helpful comments on papers and exams?</p>
<form action="q3.php" method="POST">
<label><input type="radio" name="q3"  value="5"/>5</label><br><br>
<label><input type="radio" name="q3"  value="4"/>4</label><br><br>
<label><input type="radio" name="q3" value="3"/>3</label><br><br>
<label><input type="radio" name="q3" value="2"/>2</label><br><br>
<label><input type="radio" name="q3" value="1"/>1</label><br><br>
<br><br><br><br>
