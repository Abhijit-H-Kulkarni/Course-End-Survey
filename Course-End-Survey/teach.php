...
<marquee scrollamount="20"   style="font-family:courier;font-size:40px;color:black;">HELLO SIR/MADAM!!!WELCOME TO COURSE END SURVEY.</marquee><br><br><br><br><center>
<form action="teach.php" onsubmit="return(validate());" method="POST">
...
$db=mysqli_select_db($conn,"wpproject2017") or die("failed to connect to mysql".mysqli_error($conn));
	   ...
	   $check_user="SELECT * FROM teachinfo WHERE username='$usn' AND pswd='$psw'";  
	    ...
	    {  
	        header("location:teachersfpage.php");
			$_SESSION['user']=$usn;
	       $_SESSION['psw']=$psw;
		}  
	    else  
